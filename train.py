...
def parse_args():
    ...
    parser.add_argument("--num_epochs", type=int, default=200, help="The number of epoch to train")

    parser.add_argument("--data_path", type=str, default="./DATA/Theme25", help="The address of the data file")
